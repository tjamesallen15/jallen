...
import type { NavigationItem } from "../../../../shared/common/model";
import { getNavigationItems } from "../../../../shared/common/core-base";
  ...
  return (
    <Sheet>
      <SheetTrigger className="flex justify-center items-center gap-2 group">
        ...
        <span className="text-white group-hover:text-link-accent hidden sm:block">
          Menu
        </span>
      </SheetTrigger>
      ...
      <SheetContent className="flex flex-col bg-sidebar">
        ...
        <div className="mt-32 mb-40 text-center text-2xl text-primary">
          James Allen
        </div>
            ...
            return (
              <a
                ...
                className={`${
                  ...
                  "!text-link-accent border-b-2 border-link-accent"
                } font-karla text-primary capitalize font-medium hover:text-link-accent transition-all`}
              >
                {link.name}
              </a>
            );
